...
edges = cv2.Canny((sar_image_equalized * 255).astype(np.uint8), 100, 200)
...
preprocessed_image_path = os.path.join(output_directory, 'preprocessed_image_advanced.tiff')
...
plt.subplot(2, 3, 6)
plt.title('Morphological Operation Image')
